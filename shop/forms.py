...
class CategoryForm(forms.ModelForm):
    class Meta:
        model = Category
        fields = ['name', 'sort_order', 'image', 'description', 'is_active']
        widgets = {
...
class SubcategoryForm(forms.ModelForm):
    class Meta:
        model = Subcategory
        fields = ['category', 'name', 'sort_order', 'image', 'description', 'is_active']
        widgets = {
...
class ProductForm(forms.ModelForm):
    class Meta:
        model = Product
        fields = ['category', 'subcategory', 'name', 'description', 'specifications', 
                  'price', 'sale_price', 'stock_quantity', 'is_featured', 'is_active', 'sort_order']
        widgets = {
            'category': forms.Select(attrs={
                'class': 'mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm'
            }),
            ...
            'specifications': forms.Textarea(attrs={
                ...
                'rows': 6,
                'placeholder': 'Хэмжээ: 10x20 см\nЖин: 500 гр\nӨнгө: Улаан\n(Мөр бүрд нэг үзүүлэлт)'
            }),
